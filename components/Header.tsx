      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-[#5FA777] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#4e8f63] transition-all duration-300">
              Get Quote
            </button>
          </div>
          <button 
            className="md:hidden p-2 text-gray-700 hover:text-[#1B4965] hover:bg-gray-100 rounded-lg transition-colors" 
        ...
        >
          <div className="py-4 space-y-1 border-t border-gray-100">
            ...
            <MobileDropdown label="Products" items={productItems} onItemClick={closeMobileMenu} />
            <MobileDropdown label="About" items={aboutItems} onItemClick={closeMobileMenu} />
            <a 
              href="#contact" 
              className="block py-3 text-gray-700 hover:text-[#1B4965] font-medium border-b border-gray-100" 
              onClick={closeMobileMenu}
            ...
            <button 
              className="w-full mt-4 bg-[#5FA777] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#4e8f63] transition-colors" 
              onClick={closeMobileMenu}
            >
              Get Quote
            </button>
